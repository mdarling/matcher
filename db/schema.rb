...
ActiveRecord::Schema.define(:version => 20130904215345) do
  ...
  add_index "research_users", ["confirmation_token"], :name => "index_research_users_on_confirmation_token", :unique => true
